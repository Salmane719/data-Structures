 ...
 *
 *  implementing map Adt functions: entrySet()
 *
 *  implementation of abstract hash map functions: createTable() , bucketGet ( h , k ) , bucketPut(h, k , v )
 *  bucketRemove( h , k ) , to be used for abstractHashMap functions : get() , remove() , put() .
 *
 *  other functions : size() , isEmpty, in AbstractHashMap and additional functions are toString().
 */
...
//		}
    ...
    // gets the string representation for the hash map and return string for hash map
